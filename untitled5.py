...
data['relationship_to_hh_head'] = encoder.fit_transform(data['relationship_to_hh_head'])
data['employment_category_last_year'] = encoder.fit_transform(data['employment_category_last_year'])
data['employment_type_last_year'] = encoder.fit_transform(data['employment_type_last_year'])

# Normalizing numerical variables
scaler = MinMaxScaler()
data[['age', 'education_level']] = scaler.fit_transform(data[['age', 'education_level']])

# Feature Selection (Correlation Analysis)
correlations = data.corr()['poverty_probability'].sort_values(ascending=False)
print("\nFeature Correlations with Poverty Probability:")
print(correlations)
